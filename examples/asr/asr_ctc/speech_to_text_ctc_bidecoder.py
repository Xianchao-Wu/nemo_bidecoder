...
Basic run (on CPU for 50 epochs):
    python examples/asr/asr_ctc/speech_to_text_ctc_bidecoder.py \
...
Add PyTorch Lightning Trainer arguments from CLI:
    python speech_to_text_ctc_bidecoder.py \
        ... \
...
from nemo.collections.asr.models import EncDecCTCAttnModel
...
def main(cfg):
    ...
    # TODO
    #import ipdb; ipdb.set_trace()
    asr_model = EncDecCTCAttnModel(cfg=cfg.model, trainer=trainer)
    ...
    ###import ipdb; ipdb.set_trace() # TODO todo add 4 decoding algorithms in the future
